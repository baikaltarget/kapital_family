...
export const metadata: Metadata = {
  title: "Проколоть уши ребёнку в Ангарске — с 9 месяцев, от 1000 ₽",
  description:
    "Прокол ушей ребёнку в Ангарске стерильным одноразовым пистолетом, с 9 месяцев. 2 прокола — 1000 ₽. Разметка показывается родителю до прокола. Запись по телефону.",
